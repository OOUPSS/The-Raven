# 🕯️ The Raven
![Status](https://img.shields.io/badge/status-stopped-%23FF0000)
![License](https://img.shields.io/badge/license-CC_BY--NC_4.0-%2300AA00)
![Engine](https://img.shields.io/badge/engine-Video_Ren%27Py-%231E90FF) 
...
- **Video Ren'Py** — движок визуальных новелл / visual novel engine  
- **CapCut + AI** — синематик сцены с озвучкой / cinematics & voiceover  
- **GitHub Pages** — демо и портфолио / demo & portfolio
- **Adobe Photoshop** — создание артов и интерфейсов / art and interface creation
- **FL Studio** — звуковое оформление и музыка / sound design and music
...
Коммерческое использование материалов проекта запрещено без специального разрешения.

This work is licensed under the [Creative Commons Attribution-NonCommercial 4.0 International License](https://creativecommons.org/licenses/by-nc/4.0).  
You may share and adapt the material for non-commercial purposes, with proper credit.  
Commercial use of project materials is prohibited without special permission.

---

## 📅 Дорожная карта / Roadmap

- ✅ Идея и концепт / Idea & concept
- ✅ Прототип / Prototype
- ✅ Разработка демо-версии / Demo development
- ✅ Озвучка и катсцены / Voiceover & cutscenes
...
- 👤 Сценарий / Story: OOUPPSS
- 👤 Дизайн / Design: OOUPPSS
- 👤 Программирование / Code: OOUPPSS
- 👤 Арт и UI / Art & UI: OOUPPSS
- 👤 Звуковое оформление / Sound Design: OOUPPSS

---

## 📬 Контакты / Contacts

- 📧 Email: dragoyar2005@gmail.com
- 📸 Instagram: [@oouuppss1](https://instagram.com/oouuppss1)
